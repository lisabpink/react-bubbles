...
- [ ] Explain what a token is used for.
          ...
          Client authentication, the user provides proof of who they are. 1 token is given and then stored locally on their computer, in local storage.

- [ ] What steps can you take in your web apps to keep your data secure?

          Authentication, tokens, use of .gitignore, protected routes
...
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
          ...
          .get – retrieve what you want from the site, or get data, .put updates the data and .delete deletes the data.
